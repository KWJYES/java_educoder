package educoder.Java面向对象_封装_继承和多态的综合练习.第2关_封装_继承和多态进阶二;
...
abstract class Person {
    ...
    public Person(String name, String sex, int age) {
        ...
        this.sex = sex;
        this.age = age;
        System.out.format("姓名：%s，性别：%s，年龄：%d，",name,sex,age);
    }
/********* end *********/
}
...
class Chinese extends Person {
    ...
    public void shadowBoxing(){
        System.out.println(super.name+"在练习太极拳！");
...
class English extends Person {
    ...
    public English(String name, String sex, int age) {
        super(name, sex, age);
        System.out.print("我是英国人，");
    }

    @Override
    void eat() {
        System.out.println("我喜欢吃三明治！");
    }
    public void horseRiding(){
        System.out.println(super.name+"在练习骑马！");
    };
    /********* end *********/
}
