package educoder.Java面向对象_封装_继承和多态的综合练习.第3关_封装_继承和多态进阶三;
...
public class Task3 {
    public static void main(String[] args) {
        ...
        System.out.println(pingPangPlayer.name + "---" + pingPangPlayer.age);
        ...
        System.out.println(basketballPlayer.name + "---" + basketballPlayer.age);
        ...
        System.out.println(pingPangCoach.name + "---" + pingPangCoach.age);
        ...
        System.out.println(basketballCoach.name + "---" + basketballCoach.age);
